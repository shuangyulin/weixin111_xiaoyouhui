  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">校友会系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">校友名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xiaoyouming" class="input" type="text" placeholder="校友名">
			   </div>
			 </div> -->
			<el-form-item label="校友名" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.xiaoyouming" autocomplete="off" placeholder="校友名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="院系" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.yuanxi" autocomplete="off" placeholder="院系"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">班级</div>
			...
			<el-form-item label="班级" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.banji" autocomplete="off" placeholder="班级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">工作岗位</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gongzuogangwei" class="input" type="text" placeholder="工作岗位">
			   </div>
			 </div> -->
			<el-form-item label="工作岗位" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.gongzuogangwei" autocomplete="off" placeholder="工作岗位"  />
			</el-form-item>
